...
public class HarvestCrops extends EntityAIMoveToBlock
{
    /** Villager that is harvesting */
    private final EntityMob theVillager;
    ...
    public HarvestCrops(EntityMob p_i45889_1_, double p_i45889_2_)
    {
    ...
    public void updateTask()
    {
        ...
        if (this.func_179487_f())
        {
            ...
            {
                InventoryBasic inventorybasic = new InventoryBasic("items lah", false, 8);
